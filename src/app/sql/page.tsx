      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="relative flex overflow-hidden" style={{ height: "40%" }}>
          ...
          <textarea
            ...
            className="flex-1 bg-background p-[10px] font-mono text-[13px] leading-[20px] text-foreground resize-none outline-none border-none placeholder:text-muted-foreground/30 overflow-auto"
            style={{ tabSize: 2 }}
          />
        </div>
